...
| ----------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`main.py`][main]                   | cyclopts entry point `tag()`: parse config, load the config file, apply overrides, resolve the batch, acquire the lock, run the batch, emit NDJSON, and write the summary.              |
| [`config.py`][config]               | Defaults, provider URLs, tag names, and the system and user prompts.                                                                                                                    |
...
| [`models.py`][models]               | `GeneratedMetadata` (caps title and description length and keyword count) and `InferenceResult`.                                                                                        |
...
- [AI providers](ai-providers.md): the Ollama and LM Studio backends, agent construction, model
    validation, and schema-validation retries.
